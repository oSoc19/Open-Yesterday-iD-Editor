...
export function modeAddChapel(context, mode) {
    mode.id = 'add-chapel';

    var behavior = behaviorDraw(context)
        .tail(t('modes.add_chapel.tail'))
        .on('click', add)
        .on('clickWay', addWay)
    ...
    if (mode.preset) defaultTags = mode.preset.setTags(defaultTags, 'chapel');
    ...
    function add(loc) {
        ...
        context.perform(
            ...
            t('operations.add.annotation.chapel')
        );
